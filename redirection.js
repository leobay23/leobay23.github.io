document.addEventListener("DOMContentLoaded", function() {
    ...
    if (getCookie("registered")) {
        window.location.href = 'events.html';        // Redirigir a la página siguiente si está registrado
    }
    ...
    document.getElementById('register-btn').addEventListener('click', function() {
        ...
        if (document.querySelector('.progress-bar-fill').style.width === '100%') {
            ...
            window.location.href = 'events.html';            // Redirigir a la página siguiente después de registrarse
        } else {
